...
class painelController extends Controller
{
    ...
    {
        header('LOCATION: ' . PAINEL . '/app/usuario_equipe');
    }
    ...
    public function post_upload_arquivo()
    {
        ...
        if (isset($retorno['erro']) && $retorno['erro'] == false) :
            ...
            $arquivo = $Arquivo->salvar($cod, $retorno['arquivo'], $local, true);
    ...
    public function post_upload_imagem_lista()
    {
        ...
        if (isset($imagem['erro']) && $imagem['erro'] == false) :
            $Foto = new FotoModel;
            $foto = json_decode($Foto->salvar($tabela, $cod, $imagem['arquivo']), true);
